/**************************************************************************************************
  Filename:       _sbl_spi.c
  Revised:        $Date: 2012-10-30 19:25:51 -0700 (Tue, 30 Oct 2012) $
  Revision:       $Revision: 31987 $

  Description:

  This file contains the interface to the H/W transport driver by SPI, 4P1, FD for the boot loader.
